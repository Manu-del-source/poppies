    ...
    <section id={id} ref={containerRef} className="py-32 bg-poppies-bg overflow-hidden">
      <div className="container mx-auto px-6 mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <p className="text-poppies-secondary/60 max-w-sm">Hand-picked selections from our chef, representing the vibrant pulse of Nairobi's food culture.</p>
        </div>
      </div>
        ...
        {featuredMeals.map((meal, i) => (
          ...
          >
            <div className="relative aspect-[4/5] mb-6 overflow-hidden rounded-sm">
              ...
              />
              <div className="absolute top-6 right-6 bg-poppies-accent text-white px-4 py-2 font-bold text-sm">
                {meal.price}
              </div>
            </div>
            ...
            <p className="text-poppies-secondary/60 text-sm line-clamp-2">{meal.desc}</p>
          </motion.div>
        ))}
      </motion.div>
    </section>
